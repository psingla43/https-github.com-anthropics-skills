...
JURISDICTIONS = {
    "ninth": JurisdictionConfig(
        ...
        font_size=28,  # 14pt in half-points
        line_spacing=480,
        special_rules=[
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:style w:type="paragraph" w:styleId="Title">
    ...
    <w:rPr><w:b/><w:caps/><w:sz w:val="{FONT_SIZE}"/></w:rPr>
  </w:style>
  ...
  <w:style w:type="paragraph" w:styleId="FactContent">
    <w:name w:val="Fact Content"/>
    <w:pPr>
      <w:spacing w:line="{LINE_SPACING}" w:lineRule="auto"/>
...
if __name__ == "__main__":
    ...
    # Build and save
    output_path = "/mnt/user-data/outputs/DECLARATION_FALSE_STATEMENTS.docx"
